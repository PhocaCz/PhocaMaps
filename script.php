...
{
	protected $extension 	= 'com_phocamaps';
	protected $updatetext 	= 'COM_PHOCAMAPS_UPDATE_TEXT';
	protected $installtext 	= 'COM_PHOCAMAPS_INSTALL_TEXT';
	protected $versiontext	= 'COM_PHOCAMAPS_VERSION';
	protected $extensiontext= 'COM_PHOCAMAPS';
	protected $configuretext= 'COM_PHOCAMAPS_CONFIGURE';
